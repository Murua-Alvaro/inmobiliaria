...
function App() {
  ...
  return <div className="codesin-home">
    <header className="ch-header">
      <div className="ch-brand"><div className="ch-brand__mark">G</div><div className="ch-brand__copy"><strong>GROWA</strong><span>INMOBILIARIA</span></div></div>
      ...
      <div className="ch-badge">MAPA CODESIN · 13 DISTRITOS</div>
    </header>

    <main className="ch-stage">
      <div className="ch-title"><span>TERRITORIO / MAZATLÁN</span><h1>Mapa urbano por distritos.</h1><p>La misma estructura territorial CODESIN, trasladada al producto inmobiliario con una interfaz estrictamente monocromática.</p></div>
      ...
      {selectedMeta ? <section className="ch-selection"><span>DISTRITO SELECCIONADO</span><h2>{cleanName(selectedMeta.name)}</h2><p>Esta selección será la base para agregar después composición demográfica, vivienda, precios y actividad económica.</p><div><small>AGEB integradas</small><strong>{selectedMeta.agebCount || '—'}</strong></div></section> : null}
